...
<head>
    ...
    <style>
        ...
        .nav { background: #1F2937; padding: 10px; color: #F9FAFB; margin-bottom: 20px; }
        ...
        .search-box { padding: 15px; background: #1F2937; margin-bottom: 20px; color: #F9FAFB; }
        .search-box input, .search-box select { background: #111827; color: #F9FAFB; border: 1px solid #9CA3AF; padding: 5px; }
        .search-box button { background-color: #8B5CF6; color: #F9FAFB; border: none; padding: 8px 12px; cursor: pointer; }
...
<div class="nav">
    ...
    <div class="card">
        <h1 style="color: #F9FAFB;">Available Events</h1>
